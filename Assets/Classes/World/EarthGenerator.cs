...
public class EarthGenerator : MonoBehaviour
{
    ...
    // Estructura per emmagatzemar dades del maixellat
    ...
    // Estructura per representar coordenades geogràfiques
    ...
    private void Start()
    {
        ...
        // Generar totes les cares de l'esfera
        MeshData[] faces = GenerateFaces(resolution);
        List<Vector3> allVertices = new List<Vector3>();
        List<int> allTriangles = new List<int>();

        // Combinar totes les cares en un sol maixellat
        ...
        // Assignar dades al maixellat
        mesh.vertices = allVertices.ToArray();
        mesh.triangles = allTriangles.ToArray();
        mesh.RecalculateNormals();

        // Assignar colors a cada cara
    ...
    // Transformar un punt del cub a un punt de l'esfera
    ...
    // Generar totes les cares de l'esfera basades en un cub
